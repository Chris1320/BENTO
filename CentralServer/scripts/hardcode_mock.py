...
LIQUIDATION_ENTRIES: list[LiquidationEntry] = [
    ...
    # Faculty and Student Development Fund - from actual liquidation report for January 2025
    LiquidationEntry(
        category="faculty_stud_dev_fund",
        date="2025-01-20",
        description="Cluster 1-Intramural Meet",
        quantity=1.0,
        unit="pcs",
        unit_price=360.00,
    ),
