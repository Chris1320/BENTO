            ...
            <Stack gap="lg">
                ...
                <Card withBorder>
                    <Stack gap="md">
                        <Group justify="space-between" align="flex-start">
                            <Group gap="sm">
                                <Text fw={500}>
                                    A. Certified: Expenses/Cash Advance necessary, lawful and incurred under my direct
                                    supervision
                                </Text>
                ...
                >
                    <Stack gap="md">
                        ...
                        <Stack gap="xs" pl="md">
                            <Text size="sm">
                                • Expenses/Cash Advance are necessary, lawful and incurred under your direct supervision
                            </Text>
