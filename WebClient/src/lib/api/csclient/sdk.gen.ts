 ...
 */
export const generateFinancialInsightsV1AiInsightsPost = <ThrowOnError extends boolean = false>(options: Options<GenerateFinancialInsightsV1AiInsightsPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GenerateFinancialInsightsV1AiInsightsPostResponses, GenerateFinancialInsightsV1AiInsightsPostErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const chatWithAiV1AiChatPost = <ThrowOnError extends boolean = false>(options: Options<ChatWithAiV1AiChatPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ChatWithAiV1AiChatPostResponses, ChatWithAiV1AiChatPostErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const getAiStatusV1AiStatusGet = <ThrowOnError extends boolean = false>(options?: Options<GetAiStatusV1AiStatusGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAiStatusV1AiStatusGetResponses, unknown, ThrowOnError>({
        url: '/v1/ai/status',
        ...options
    });
};
...
/**
 * Request Verification Email Admin
 ...
 */
export const requestVerificationEmailAdminV1AuthEmailRequestAdminPost = <ThrowOnError extends boolean = false>(options: Options<RequestVerificationEmailAdminV1AuthEmailRequestAdminPostData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<RequestVerificationEmailAdminV1AuthEmailRequestAdminPostResponses, RequestVerificationEmailAdminV1AuthEmailRequestAdminPostErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
 ...
 */
export const googleOauthLoginLinkV1AuthOauthGoogleLoginLinkGet = <ThrowOnError extends boolean = false>(options?: Options<GoogleOauthLoginLinkV1AuthOauthGoogleLoginLinkGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GoogleOauthLoginLinkV1AuthOauthGoogleLoginLinkGetResponses, unknown, ThrowOnError>({
...
/**
 * Get School Monthly Report Quantity
 ...
 */
export const getSchoolMonthlyReportQuantityV1ReportsMonthlySchoolIdQuantityGet = <ThrowOnError extends boolean = false>(options: Options<GetSchoolMonthlyReportQuantityV1ReportsMonthlySchoolIdQuantityGetData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetSchoolMonthlyReportQuantityV1ReportsMonthlySchoolIdQuantityGetResponses, GetSchoolMonthlyReportQuantityV1ReportsMonthlySchoolIdQuantityGetErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
